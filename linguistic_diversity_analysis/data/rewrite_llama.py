...
prompts_for_questions = {
    ...
    "clarity": """Rewrite the following text to improve clarity and readability: \"{}\"""",
    "conciseness": """Rewrite the following text to make it more concise while preserving meaning: \"{}\"""",
    "fluency": """Rewrite the following text to improve overall fluency and flow: \"{}\"""",
    "naturalness": """Rewrite the following text so it reads more naturally in English: \"{}\"""",
    "plain_language": """Rewrite the following text in clear and straightforward language: \"{}\"""",
    "polish": """Polish the following text to improve its overall quality without changing its meaning: \"{}\"""",
    "academic": """Rewrite the following text in a more polished academic style without altering meaning: \"{}\"""",
    "formalize": """Rewrite the following text in a more formal way without adding or removing content: \"{}\"""",
    "smooth": """Rewrite the following text to ensure smooth transitions and consistent flow: \"{}\"""",
    "improve_readability": """Rewrite the following text to enhance readability: \"{}\"""",
}
